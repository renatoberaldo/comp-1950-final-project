...
<main>
		<div class="banner">
			<img src="images/banner-outline.jpg" alt="">
			<div class="info-box">
				<h1 class="hero-heading">
					<span class="course_name">OUTLINE</span>
				</h1>
			</div>
		</div>
					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td>20</td>
								<td>The mid-term project must be submitted in order to pass this course.</td>
							</tr>
							<tr>
								<td>Mid-Term Exam</td>
								<td>10</td>
							...
							<tr>
								...
								<td>30</td>
								<td>The final group project must be submitted in order to pass this course.</td>
							</tr>
							<tr>
								<td>Final Exam</td>
								<td>20</td>
